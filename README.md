...
Interactive, translucent slime rendered with Three.js. Coat DOM text and containers with sticky, draggable slime.
...
The demo includes neon lime `#c4ff00`, amber `#ffb800`, pink `#ff26b9`, purple `#5900ff`, blue `#00cfff`, mint `#00ffe0`, and green `#00ffaa`.
...
| `data-goo-solid="text"` | Captures glyphs for the initial coating and sticky relief; also add `data-goo`   |
...
slime.pause();
slime.play();
slime.reset(); // Rebuild the initial coating.
